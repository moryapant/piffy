...
<template>
  <div :class="[
    ...
    <!-- Vote Buttons Container - Responsive Sizing -->
    <div class="inline-flex items-center rounded-full bg-gray-100 px-1 py-0.5 sm:px-2 sm:py-1 md:px-3 md:py-1.5 lg:px-3 lg:py-1.5">
      <!-- Upvote Button -->
      <button 
        ...
        :class="[
          ...
          'w-10 h-7 sm:w-8 sm:h-8 md:w-10 md:h-9 lg:w-12 lg:h-10', // Progressive sizing: mobile -> sm -> md -> lg
          hasUpvoted 
      ...
      >
        <svg :class="['fill-current', 'w-4 h-4 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-5 lg:h-5']" viewBox="0 0 24 24">
      ...
      <div :class="[
        ...
        'px-2 min-w-[2.5rem] sm:px-2 sm:min-w-[2rem] md:px-3 md:min-w-[3rem] lg:px-3 lg:min-w-[3.5rem]',
        'text-xs sm:text-xs md:text-sm lg:text-sm', // Progressive text sizing
    ...
    <Link
      ...
      class="flex items-center gap-1.5 px-3 py-1.5 md:px-4 md:py-2 lg:px-4 lg:py-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
      @click.stop
    >
      <!-- Comment Icon -->
      <svg class="w-4 h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Views Count -->
    <div class="flex items-center gap-1.5 px-3 py-1.5 md:px-4 md:py-2 lg:px-4 lg:py-2 rounded-full bg-gray-50 text-gray-600 select-none">
      <!-- Eye Icon -->
      <svg class="w-4 h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
