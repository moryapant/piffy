  ...
  <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex md:items-center md:space-x-6 flex-grow justify-center">
          <!-- Navigation Links -->
          ...
          <template v-if="$page.props.auth.user">
            ...
            <Menu as="div" class="relative">
              <div>
                ...
                >
                  <img
                    :src="$page.props.auth.user.avatar || 'https://www.gravatar.com/avatar/?d=mp'"
                ...
                >
                  <div class="py-1">
                    <MenuItem v-slot="{ active }">
                      ...
                      >
                        <svg class="w-4 h-4 mr-3 text-gray-500 group-hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        Dashboard
                      </Link>
