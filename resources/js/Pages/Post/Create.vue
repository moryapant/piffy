        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <!-- Subfapp Selection -->
                    <div>
                        <label for="subfapp" class="block text-sm font-medium text-gray-700">Choose a Community</label>
                        <select 
                            id="subfapp"
                    ...
                    <div>
                        ...
                        <!-- Image Preview -->
                        <div v-if="imagePreviewUrls.length" class="mt-4 grid grid-cols-2 gap-4">
                            <div 
