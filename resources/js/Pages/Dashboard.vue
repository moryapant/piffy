    ...
    <div class="py-12 bg-gray-50">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="overflow-hidden bg-white shadow-lg sm:rounded-xl">
          ...
          ></div>
          <div class="relative px-4 pb-8 -mt-16 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center">
              <img
                ...
                "
                :alt="user.name"
                class="object-cover w-32 h-32 border-4 border-white rounded-full shadow-xl"
              />
              ...
              <div
                class="flex items-center mt-2 space-x-2 text-sm text-gray-500"
              >
                <svg
                  class="w-4 h-4"
                  fill="none"
            ...
            <div class="grid gap-6 mt-8 sm:grid-cols-2 lg:grid-cols-3">
              <!-- Posts Card -->
              <div
                class="p-6 transition-all duration-200 bg-white border rounded-xl hover:shadow-md"
              >
                <div class="flex items-center justify-between">
                ...
                <p class="mt-1 text-sm text-gray-500">Posts created</p>
              </div>
              ...
              >
                ...
                <p class="mt-1 text-sm text-gray-500">Comments made</p>
              </div>
                ...
                <div class="flex justify-between mt-2">
                  <div class="text-center">
                    <span class="text-sm font-medium text-green-600"
                      >↑ {{ stats.upvotes_given }}</span
                    >
                    <p class="text-xs text-gray-500">Upvotes</p>
                  </div>
                  <div class="text-center">
                    <span class="text-sm font-medium text-red-600"
                      >↓ {{ stats.downvotes_given }}</span
                    >
