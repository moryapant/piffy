...
<template>
  <Head title="Home - Fappify" />

  <MainLayout>
    <div class="py-4 sm:py-6 md:py-8 mx-auto space-y-4 sm:space-y-6 px-2 sm:px-4 md:px-6 lg:px-8">
      <!-- Main Content -->
      <div class="flex flex-col lg:flex-row gap-3 sm:gap-6">
        ...
        <div class="flex-grow space-y-4">
          ...
          <!-- Posts List -->
          <div v-if="posts.data.length > 0" class="space-y-3 sm:space-y-4">
            <PostCard
